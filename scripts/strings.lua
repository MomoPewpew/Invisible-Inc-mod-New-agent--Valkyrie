local MOD_STRINGS =
{
	...
	ITEMS =
	{
		...
		ITEM_CAMERA_LAUNCHER_DESCR = "Launch a compact Blackeye Camera at a location that you can see, providing 360 degree vision in an area. Blackeye Cameras can not be recovered. \nEach use of this item consumes one charge. Recharges between missions.",
